                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="estadoDni" name="estadoDni" required>
                                    ...
                                    <option value="Nunca lo tramitó/indocumentado/a">Nunca lo tramitó/indocumentado/a
                                    </option>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Respiratorios"> Respiratorios<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="En la piel"> En la piel<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="En la vista"> En la vista<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Gástricos"> Gástricos<br>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Ginecológicos"> Ginecológicos<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Alergias"> Alergias<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="En los huesos/articulaciones"> En los huesos/articulaciones<br>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Situaciones de violencia"> Situaciones de violencia<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Consumo problemático de sustancias"> Consumo problemático de
                                            sustancias<br>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col">
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Hipertensión"> Hipertensión<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Problemas de tiroides"> Problemas de tiroides<br>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Odontológicos"> Odontológicos<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Cáncer"> Cáncer<br>
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="Infecciones de transmisión sexual"> Infecciones de transmisión
                                            sexual<br>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="enfermedadesCronicas[]"
                                                value="con discapacidad"> Discapacidad ¿tiene certificado único de
                                            discapacidad?<br>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            <button type="submit" class="btn btn-custom btn-block" name="funcion"
                                value="agregar">Agregar Integrante</button>
                        </div>
                        <div class="col-md-6">
                            <button type="submit" class="btn btn-custom btn-block" name="funcion"
                                value="">Guardar Integrantes</button>
                        </div>
                    </div>
                </div>
            </form>
                                    ...
                                    <tbody>
                                        @foreach ($integrantes as $integrante)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('integrante.destroy', $integrante->intId) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger"
                                                            onclick="return confirm('¿Estás seguro de que deseas eliminar a '.$integrante->nombre.' '.$integrante->apellido.' ?')">Borrar</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
