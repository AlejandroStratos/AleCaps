            ...
            <div class="col-md-6">
                ...
                <form action="{{ route('encuesta.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="accSalud1">¿Cómo considera que es el acceso a la atención en salud suyo y/o de su
                            familia?</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="accMental1">¿Alguien en el grupo familiar recibe tratamiento en Salud Mental
                                (Psicológico y/o Psiquiátrico)?</label>
                        ...
                        <div class="form-group">
                            <label for="prSoysa">De la siguiente lista de problemas sociales y de salud ¿cuáles son los 3
                                principales que identifica en el barrio?</label>
                            <select name="prSoysa" id="prSoysa" class="form-control">
                                ...
                                <option value="No finalizar la escuela secundaria">No finalizar la escuela secundaria
                                </option>
                                ...
                                <option value="Problemas en el acceso a la salud">Problemas en el acceso a la salud
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="vivienda6" id="vivienda6" class="form-control">
                                ...
                                <option value="Fuera de la vivienda, pero dentro del terreno">Fuera de la vivienda, pero
                                    dentro del terreno</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="accBas1" id="accBas1" class="form-control">
                                <option value="">Seleccionar</option>
                                <option value="por cañería dentro de la vivienda">por cañería dentro de la vivienda
                                </option>
                                <option value="fuera de la vivienda pero dentro del terreno">fuera de la vivienda pero
                                    dentro del terreno</option>
