                                ...
                                <tbody>
                                    ...
                                    @foreach ($usuarios as $usuario)
                                        <tr>
                                            ...
                                            <td style="display:none">{{ $usuario->userId }}</td>
                                            ...
                                            <td style="text-align:center;">
                                                <a class="btn btn-primary btn-sm active" role="button"
                                                    aria-pressed="true" href="{{ Route('usuario.edit', $usuario->userId) }}" >Editar
                                                    <i class="fas fa-edit" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                            <td style="text-align:center;">
                                                <form action="{{ Route('usuario.destroy', $usuario->userId) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method ('DELETE')
                                                ...
                                                <form action="{{ Route('usuario.asignar') }}" method="POST">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group mb-1">
                                                            <select name="capId" aria-label="Reasignar"
                                                                class="form-control">
                                                                <option value="" disabled selected>Reasignar</option>
                                                                @foreach ($caps as $cap)
                                                                    <option value="{{ $cap->capId }}">
                                                                        {{ $cap->capId }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="input-group-append">
                                                            <button type="submit"
                                                                class="btn btn-warning">Asignar</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </td>
